...
use Campusapp\Presentation\Model\RegistrationsModel;
...
class RegistrationsController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->rm = new RegistrationsModel();
    }
    ...
    public function addRegistration(array $post): Registration {
        ...
        try {
            $attendance = $ac->addAttendance($post);
            $registration = $this->rs->addRegistration($attendance, $post['firstYearInCampus'],
                ...
                $post['emailSpread'], $post['imageRights'], $post['musicalKnowledge']);
            return $registration;
        } catch (\Exception $e) {
            throw $e;
        }
